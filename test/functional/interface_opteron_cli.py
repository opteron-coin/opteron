...
class TestopteronCli(opteronTestFramework):
    ...
    def run_test(self):
        ...
        self.log.info("Compare responses from getinfo RPC and `opteron-cli getinfo`")
        ...
        self.log.info("Compare responses from `opteron-cli -getinfo` and the RPCs data is retrieved from.")
