...
class BIP66Test(AstralTestFramework):
    ...
    def run_test(self):
        ...
        with mininode_lock:
            ...
            # astrald is running with multiple script check threads. If script
            # check threads are not in use, then transaction script validation
            # happens sequentially, and astrald produces more specific reject
            # reasons.
