...
class BIP66Test(opteronTestFramework):
    ...
    def run_test(self):
        ...
        with mininode_lock:
            ...
            # opterond is running with multiple script check threads. If script
            # check threads are not in use, then transaction script validation
            # happens sequentially, and opterond produces more specific reject
            # reasons.
