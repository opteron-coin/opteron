...
def custom_function():
    ...
    # self.log.info("running custom_function")  # Oops! Can't run self.log outside the AstralTestFramework
    pass

class ExampleTest(AstralTestFramework):
    # Each functional test is a subclass of the AstralTestFramework class.
    ...
    def custom_method(self):
        ...
        AstralTestFramework class so other tests can use it."""
