...
def custom_function():
    ...
    # self.log.info("running custom_function")  # Oops! Can't run self.log outside the opteronTestFramework
    pass

class ExampleTest(opteronTestFramework):
    # Each functional test is a subclass of the opteronTestFramework class.
    ...
    def custom_method(self):
        ...
        opteronTestFramework class so other tests can use it."""
