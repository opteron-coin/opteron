...
class RawAssetTransactionsTest(AstralTestFramework):
    ...
    def atomic_swaps(self):
        ...
        # n1 buys 400 ANDUIN from n2 for 4000 ASTRAL
        price = 4000
        amount = 400
        fee = 0.0001
        ...
        # n2 buys JAINA! from n1 for 20000 ASTRAL
        price = 20000
        amount = 1
