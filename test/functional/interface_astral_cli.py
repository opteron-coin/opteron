...
class TestAstralCli(AstralTestFramework):
    ...
    def run_test(self):
        ...
        self.log.info("Compare responses from getinfo RPC and `astral-cli getinfo`")
        ...
        self.log.info("Compare responses from `astral-cli -getinfo` and the RPCs data is retrieved from.")
