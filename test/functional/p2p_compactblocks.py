...
# TestNode: A peer we use to send messages to opterond, and store responses.
...
class CompactBlocksTest(opteronTestFramework):
    ...
    # This test actually causes opterond to (reasonably!) disconnect us, so do this last.
    ...
    # Test that opterond requests compact blocks when we announce new blocks
    ...
    def test_incorrect_blocktxn_response(self, node, test_node, version):
        ...
        # Note that it's possible for opterond to be smart enough to know we're
    ...
    def test_getblocktxn_handler(self, node, test_node, version):
        # opterond will not send blocktxn responses for blocks whose height is
