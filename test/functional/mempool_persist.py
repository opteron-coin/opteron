...
By default, opterond will dump mempool on shutdown and
...
class MempoolPersistTest(opteronTestFramework):
    ...
    def run_test(self):
        ...
        self.start_node(0)
        self.start_node(1)
        # Give opterond a second to reload the mempool
        time.sleep(1)
        ...
        self.log.debug("Prevent opterond from writing mempool.dat to disk. Verify that `savemempool` fails")
