...
By default, astrald will dump mempool on shutdown and
...
class MempoolPersistTest(AstralTestFramework):
    ...
    def run_test(self):
        ...
        self.start_node(0)
        self.start_node(1)
        # Give astrald a second to reload the mempool
        time.sleep(1)
        ...
        self.log.debug("Prevent astrald from writing mempool.dat to disk. Verify that `savemempool` fails")
