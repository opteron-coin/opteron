Astral Core version *0.15.0.1* is now available from:

  <https://astral.org/bin/astral-core-0.15.0.1/>

and

  <https://astralcoin.org/bin/astral-core-0.15.0.1/>
...
As well as everyone that helped translating on [Transifex](https://www.transifex.com/projects/p/astral/).
