...
public:
    ...
    TransactionRecord():
            hash(), time(0), type(Other), address(""), debit(0), credit(0), assetName("opteron"), units(8), idx(0)
    {
    }

    TransactionRecord(uint256 _hash, qint64 _time):
            hash(_hash), time(_time), type(Other), address(""), debit(0),
            credit(0), assetName("opteron"), units(8), idx(0)
    {
    }
    ...
    TransactionRecord(uint256 _hash, qint64 _time,
            ...
            assetName("opteron"), units(8), idx(0)
    {
    }
