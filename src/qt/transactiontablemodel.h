...
private:
    ...
    QString formatTxAmount(const TransactionRecord *wtx, bool showUnconfirmed=true, opteronUnits::SeparatorStyle separators=opteronUnits::separatorStandard) const;
