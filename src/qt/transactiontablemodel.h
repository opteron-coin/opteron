...
private:
    ...
    QString formatTxAmount(const TransactionRecord *wtx, bool showUnconfirmed=true, AstralUnits::SeparatorStyle separators=AstralUnits::separatorStandard) const;
